    ...
    return (
        ...
        >
            <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex flex-col md:flex-row items-start gap-3 md:gap-4 p-4 md:p-6 bg-gray-100 rounded-xl border border-gray-200">
                    <div className="p-2 md:p-3 bg-gray-900 rounded-xl flex-shrink-0 hidden md:block">
                        <Building className="h-6 w-6 md:h-8 md:w-8 text-white" />
                    </div>
                    <div className="flex-1 min-w-0">
                        <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4">Información de la Sucursal</h3>
                ...
                <div className="space-y-4 md:space-y-6">
                    <div className="flex items-center gap-2 md:gap-3 pb-2 md:pb-3 border-b border-gray-200">
                        <div className="p-1.5 md:p-2 bg-gray-100 rounded-lg">
                            <CreditCard className="h-4 w-4 md:h-5 md:w-5 text-gray-900" />
                        </div>
                    ...
                    <div className="space-y-4 md:space-y-6">
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                rows={2}
                                className="text-sm md:text-base border-gray-200 focus:border-gray-900 focus:ring-gray-900/20 resize-none"
                            />
                        </div>
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-3 md:gap-4 pt-4 md:pt-6 border-t border-gray-200">
                    ...
                    <Button
                        ...
                        className="bg-gray-900 hover:bg-gray-900/90 text-white disabled:bg-gray-400 disabled:cursor-not-allowed text-sm md:text-base"
                    >
